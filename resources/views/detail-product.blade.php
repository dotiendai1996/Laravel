              ...
              <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
                ...
                <div class="large-image">
                  <a href="images/products/img03.jpg" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20">
                    <img class="zoom-img" src="{{url('images/products/img03.jpg')}}" alt="products"> </a>
                </div>
              </div>
                    ...
                    <div class="item-inner fadeInUp">
                      <div class="product-thumbnail">
                        ...
                        <div class="pr-img-area">
                          <img class="first-img" src="{{url('images/products/img03.jpg')}}" alt="">
                          <img class="hover-img" src="{{url('images/products/img03.jpg')}}" alt="">
